...
class TradingEnv(gym.Env):
    ...
    def step(self, action: int):
        ...
        - risk_adjusted: penalitza moviments extrems del retorn
        - volatility_penalty: penalitza directament la volatilitat observada
        """
        ...
        elif self.reward_mode == "volatility_penalty":
